...
/**
 * Teste de `CategoriasProdutos`.
 */
class CategoriasProdutosTest extends TestCase
{
     ...
     */
    private function getInstance(IBlingRepository $repository): CategoriasProdutos
    {
        return new CategoriasProdutos($repository);
    }
        ...
        $repository->expects($this->once())
            ...
            ->with(
                $this->callback(
                    ...
                    $requestOptions->endpoint === "categorias/produtos/$idCategoriaLoja"
                )
            )
    ...
    public function testShouldGetSuccessfully(): void
    {
        ...
        $repository->expects($this->once())
            ...
            ->with(
                $this->callback(
                    fn(RequestOptions $requestOptions) =>
                    $requestOptions->endpoint === "categorias/produtos"
